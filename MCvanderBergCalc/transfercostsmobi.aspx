<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="transfercostsmobi.aspx.cs" Inherits="MCvanderBergCalc.transfercostsmobi" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="ctl00_Head1">
    <title>TransferCostMobi - MC Van Der Berg Inc
    </title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <link rel="search" type="application/opensearchdescription+xml" title="MC Van Der Berg Inc Site Search" href="http://www.mcvdbergattorneys.co.za/SearchEngineInfo.ashx" />
    <meta name="viewport" content="initial-scale = 1.0, maximum-scale = 1.0, user-scalable = no, width = device-width" />
    <link rel='stylesheet' type='text/css' href='//ajax.googleapis.com/ajax/libs/jqueryui/1.10.2/themes/sunny/jquery-ui.css' />

    <link rel='shortcut icon' href='/Data/Sites/1/skins/MCClean/favicon.ico' />
    <style>
        .art-post {
    ...
    <link rel='stylesheet' type='text/css' href='/Content/mobiSite.css' />

</head>
<body id="ctl00_Body" class="pagebody" style="min-width: 0px !important">
                                ...
                                <div id='ctl00_mainContent_ctl00_pnlOuterWrap' class='art-content clearfix'>
                                    ...
                                    <div id='ctl00_mainContent_ctl00_pnlInnerWrap' class='panelwrapper eventcalendar eventcalendarbasic'>
                                        <div class='art-post art-article'>
                                            <a id='module1689' class='moduleanchor'></a>
                                                        ...
                                                        <div id='ctl00_mainContent_ctl00_pnlInnerBody' class='modulecontent'>
                                                            ...
                                                            <div id="ctl00_mainContent_ctl00_upFolderNames">
                                                                ...
                                                                <div id="ctl00_mainContent_ctl00_pnlCRM" class="modulecontent">
                                                                    ...
                                                                    <div style="width: 100%; height: auto;" class="calcContainer">
                                                                        <div style="width: 100%; text-align: center" class="calcInput">
                                                                            ...
                                                                            <div style="">
                                                                                <div style="width: 100%; padding: 10px; font-size: 1.1em; font-weight: bold">
                                           ...
                                           <%-- <input name="ctl00$mainContent$ctl00$txtBondAmount" type="text" value="0" maxlength="255" id="ctl00_mainContent_ctl00_txtBondAmount" class="currency" onclick="this.value = &#39;&#39;" onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" onblur="this.value = formatCurrency(this.value, &#39;bondamount&#39;);" />--%>
                                                                            ...
                                                                            <div style="">
                                                                                <div style="width: 100%; padding: 10px; font-size: larger; font-weight: bold">
                                                                                    ...
                                                                                    <%-- <span class='art-button-wrapper'><span class='art-button-l'></span><span class='art-button-r'></span>
                                                                                        <input type="submit" name="ctl00$mainContent$ctl00$btnCalculate" value="Calculate" id="ctl00_mainContent_ctl00_btnCalculate" class="art-button" /></span>
                                                                                    <span class='art-button-wrapper'><span class='art-button-l'></span><span class='art-button-r'></span>
                                                                                        <input type="submit" name="ctl00$mainContent$ctl00$btnReset" value="Reset" id="ctl00_mainContent_ctl00_btnReset" class="art-button" /></span>--%>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <div id="printablediv" style="width: 100%; height: 850px">
                                                                            <div style="" class="calcContent">
                                                                                <div style="margin: 3px; padding: 10px; border: 1px solid #cccccc; background-color: #eeeeee; border-radius: 5px; height: 400px">
                                                ...
                                                <span id="ctl00_mainContent_ctl00_lblDuty" class="calcSectionValue">
                                                    <asp:Label ID="lblTransferDuty" runat="server" Text="Label"></asp:Label></span>
                                                                                    ...
                                                                                    <div style="clear: both"></div>
                                                                                    <div style="border-top: 1px solid #999999; margin-left: 200px; margin-right: 5px"></div>
                                                                                    <div style="clear: both"></div>

                                                                                    <div style="float: left; font-size: 1.1em; margin-top: 20px; font-weight: bold" class="calcSectionTitle"><span id="ctl00_mainContent_ctl00_lblTotalTransferCostLabel">Total Transfer Cost</span></div>
                                                ...
                                                <span id="ctl00_mainContent_ctl00_lblTotalTransferCost" class="calcSectionTotal">
                                                    <asp:Label ID="lblTotalTransferCost" runat="server" Text="Label"></asp:Label></span>
                                                                                    ...
                                                                                    <div style="width: 100%; font-size: 0.8em; margin-top: 20px; line-height: 120%; color: #666666">
                                                ...
                                                <span id="ctl00_mainContent_ctl00_lblBondBankFee" class="calcSectionValue">
                                                    <asp:Label ID="lblBankAdminFee" runat="server" Text="Label"></asp:Label></span>
                                                                                    ...
                                                                                    <div style="float: left" class="calcSectionTitle" title=""><span id="ctl00_mainContent_ctl00_lblElectronicDocumentFeeLabelBond" title="The &lt;strong>Vendor Software Package Fee&lt;/strong> is a disbursement charged by our software vendor to generate all the formal bond documents in the transferring process.">Vendor Software Package Fee</span> <sup title='Including VAT'><span>Incl VAT</span></sup></div>
                                                                                    <div style="" class="calcSectionValue">
                                                                                        R
                                                ...
                                                <span id="ctl00_mainContent_ctl00_lblBondDeeds" class="calcSectionValue">
                                                    <asp:Label ID="lblDeedsOfficeBond" runat="server" Text="Label"></asp:Label></span>
                                                                                    ...
                                                                                    <div style="float: left; font-size: 1.1em; margin-top: 20px; font-weight: bold" class="calcSectionTitle"><span id="ctl00_mainContent_ctl00_lblTotalBondCostLabel">Total Bond Cost</span></div>
                                                                                    <div class="calcSectionValue" style="font-size: 1.1em; margin-top: 20px">
                                                                                        R
                                                <span id="ctl00_mainContent_ctl00_lblTotalBondCost" class="calcSectionTotal">
                                                    <asp:Label ID="lblTotalBondCost" runat="server" Text="Label"></asp:Label></span>
                                                                        ...
                                                                        <div style="width: 100%; text-align: center; margin-left: 10px; margin-bottom: 10px">
                                                                            <div class="calcTotal">
                                                                                <span id="ctl00_mainContent_ctl00_lblTotalEstimateLabel" style="font-weight: normal;">Total Estimate Cost</span>:<br />
                                                                                R 
                                        <span id="ctl00_mainContent_ctl00_lblTotal">
                                            <asp:Label ID="lblTotalEstimate" runat="server" Text="Label"></asp:Label></span>
                                                                    ...
                                                                    <br />
                                                                    <div class="calcContainer" style="width: 100%; height: auto;">
                                                                        ...
                                                                        <div style="width: 100%; padding: 10px">
                                                                            ...
                                                                            <span class='art-button-wrapper'><span class='art-button-l'></span><span class='art-button-r'></span>
                                                                                <%--  <input type="submit" name="ctl00$mainContent$ctl00$btnQuote" value="Send" id="ctl00_mainContent_ctl00_btnQuote" class="art-button" /></span>--%>
                                                                    ...
                                                                    <br />
                                                                    <div class="calcContainer" style="width: 100%; height: auto; margin-right: auto">
                                                                        <div style="width: 100%" class="calcInput">
                                                                        ...
                                                                        <div style="width: 100%; padding: 10px">
                                                                            ...
                                                                            <div style="" class="calcSectionValue">
                                                                                <textarea name="ctl00$mainContent$ctl00$txtMessage" id="ctl00_mainContent_ctl00_txtMessage" rows="5" cols="10" placeholder="Message" style="width: 60%"></textarea>
                                                                            </div>
        ...
        <div class="topnavwrap" style="display: none">
            <div class="topnav">
                <ul>
                    ...
                    <li class="topnavitem"><a class="sitelink" rel="nofollow" href="/Secure/Register.aspx?returnurl=%2ftransfercostmobi">Register</a></li>
                    <li class="topnavitem"><a class="sitelink" rel="nofollow" href="/Secure/Login.aspx?returnurl=%2ftransfercostmobi">Sign In</a></li>
