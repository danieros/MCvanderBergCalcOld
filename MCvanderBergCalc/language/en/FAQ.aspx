<%@ Page Language="C#" MasterPageFile="~/EnglishSite.Master" AutoEventWireup="true" CodeBehind="FAQ.aspx.cs" Inherits="MCvanderBergCalc.language.en.FAQ" %>
...
<%--                        <p>
                            <a href="http://gpdemo.co.za/mcvdbergGill/wp-content/uploads/2015/04/faq-vergadering.jpg">
                                <img class="alignnone size-full wp-image-277" src="http://gpdemo.co.za/mcvdbergGill/wp-content/uploads/2015/04/faq-vergadering.jpg" alt="faq---vergadering" width="770" height="340" /></a>
                        </p>--%>
                        <div class="omsc-accordion">
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Do I have to pay my bond originator a professional fee?</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4342">
                                        <div class="pf-content">
                                            <p>No – the service of a bond originator is free. The banks pay the bond originator a professional fee as the bond originators are contracted to the bank.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">What happens to my Title Deed after registration of the bond?</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4344">
                                        <div class="pf-content">
                                            <p>Your original Title Deed will be sent to the financial institution as additional security for the loan after the bond has been registered.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Will my bond be cancelled automatically if I settled the amount in full?</div>
                                <div class="omsc-toggle-inner">

                                    <div class="content_block" id="custom_post_widget-4346">
                                        <div class="pf-content">
                                            <p>No. Even in cases where your bond is settled in full, the bond still needs to be cancelled in the Deeds Office and a fee will be payable to the attorneys attending to the cancellation of the bond in the Deeds office.</p>
                                        </div>
                                    </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">What is the Bond Initiation Fee?</div>
                                <div class="omsc-toggle-inner">

                                    <div class="content_block" id="custom_post_widget-4348">
                                        <div class="pf-content">
                                            <p>The National Credit Act 34 of 2005, currently allows banks to charge an amount of up to R5 700 for initiation fees to cover their administration costs. You may elect to have the Initiation Fee added to the principal debt or to pay it as part of your costs, before registration of the bond.</p>
                                        </div>
                                    </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">What is the bond registration fee?</div>
                                <div class="omsc-toggle-inner">

                                    <div class="content_block" id="custom_post_widget-4350">
                                        <div class="pf-content">
                                            <p>These fees are the attorney costs, as per the recommended fees of the Law Society, for their service of registering your bond at the Deeds Office. It is paid to the bond attorney before registration.</p>
                                        </div>
                                    </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">I have been approved for a loan by my bank. May I appoint any conveyancer to register my bond?</div>
                                <div class="omsc-toggle-inner">

                                    <div class="content_block" id="custom_post_widget-4352">
                                        <div class="pf-content">
                                            <p>No. The bank will have a specific local panel of conveyancers which is authorised to register bonds. Find out if your preferred conveyancer is on the panel of conveyancers before you request the bank to send the instruction to the conveyancer.</p>
                                        </div>
                                    </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">I have to sign an “authority to pay”. What is this document?</div>
                                <div class="omsc-toggle-inner">

                                    <div class="content_block" id="custom_post_widget-4354">
                                        <div class="pf-content">
                                            <p>This document instructs the bank to issue guarantees and to make payment of the borrowed funds on the date of registration.</p>
                                        </div>
                                    </div>
                            ...
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">What are your trading times?</div>
                                <div class="omsc-toggle-inner">

                                    <div class="content_block" id="custom_post_widget-4356">
                                        <div class="pf-content">
                                            <p>Weekdays 8:00-16:30</p>
                                        </div>
                                    </div>
                                </div>
                    </div>
