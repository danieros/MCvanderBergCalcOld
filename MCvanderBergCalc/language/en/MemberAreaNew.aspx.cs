    ...
    public partial class MemberAreaNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    lblBirthName.Text = linqGetUser.First_name;
                    lblNickName.Text = linqGetUser.NickName;
                    lblSurname.Text = linqGetUser.Last_name;
                    lblEmail.Text = linqGetUser.EmailPrimary;
                    lblCell.Text = linqGetUser.Cell_Phone;

                    var linqAgency = (from a in db.Agencies
                                      where a.AgencyID == Convert.ToInt32(linqGetUser.AgencyID)
