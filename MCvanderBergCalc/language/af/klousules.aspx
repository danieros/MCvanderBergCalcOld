<%@ Page Language="C#" MasterPageFile="~/AfrikaansSite.Master" AutoEventWireup="true" CodeBehind="klousules.aspx.cs" Inherits="MCvanderBergCalc.language.af.klousules" %>
...
<![endif]-->
	...
	<head profile="http://gmpg.org/xfn/11">
		...
		<title>Klousules | M.C. van der Berg Incorporated</title>
...
<![endif]-->
		...
		<link rel="alternate" type="application/rss+xml" title="M.C. van der Berg Incorporated &raquo; Klousules Comments Feed" href="http://gpdemo.co.za/mcconcept/language/af/klousules/feed/" />
		<script type="text/javascript">
		...
		<link rel='canonical' href='http://gpdemo.co.za/mcconcept/language/af/klousules/' />
		<link rel='shortlink' href='http://gpdemo.co.za/mcconcept/?p=940' />
		...
		<link rel="alternate" href="http://gpdemo.co.za/mcconcept/language/en/clauses/" hreflang="en" />
		<link rel="alternate" href="http://gpdemo.co.za/mcconcept/language/af/klousules/" hreflang="af" />
		<!--[if IE 7]>
...
<![endif]-->
	...
	<body class="page page-id-940 page-template-default custom-background _masterslider _ms_version_2.2.1 gecko et_includes_sidebar">
					...
					<div class="pf-content">
						...
						<div class="omsc-accordion">
							...
							<div class="omsc-toggle">
								<div class="omsc-toggle-title">Addendums</div>
								<div class="omsc-toggle-inner">
									</p>
																		<ul class="check-list">
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2878">Onderhewige Verkoop</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2880">Verhuring</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2882">Aanhegtings &amp; Toebehore</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2884">Blanko Addendum</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2886">Verslag oor die toestand van die onroerende eiendom</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2888">Nul Koers BTW transaksies</a></li>
																		</ul>
									<p>
								</div>
							</div>
							...
							<div class="omsc-toggle">
								...
								<div class="omsc-toggle-inner">
																		...
																		<ul class="check-list">
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2874">Elektrisiteitsertifikaat</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2876">Gassertifikaat</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2875">Elektriese Omheiningssertifikaat</a></li>
																			<li><a href="http://www.mcvdberg.co.za/LiteratureRetrieve.aspx?ID=2890">Geen Agentekommissie</a></li>
																		</ul>
									<p>
								</div>
							</div>
		...
		<!-- 122 queries in 0.831 seconds, using 24.12MB memory -->
