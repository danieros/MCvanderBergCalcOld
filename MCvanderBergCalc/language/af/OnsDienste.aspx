<%@ Page Language="C#" MasterPageFile="~/AfrikaansSite.Master" AutoEventWireup="true" CodeBehind="OnsDienste.aspx.cs" Inherits="MCvanderBergCalc.language.af.OnsDienste" %>
        ...
        <div id="left-area">
            ...
            <div id="entries">
                <div class="entry post clearfix">
                    <h1 class="title">Ons Dienste</h1>


                    <div class="pf-content">
                        <p>
                            <img src="https://mcvdberg.blob.core.windows.net/generalimages/OurServices.jpg" alt="" />
                        </p>
                        <div class="omsc-accordion">
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Ooreenkomste</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4280">
                                        <div class="pf-content">
                                            <ul>
                                                <li>Verkoop van eiendom</li>
                                                <li>Leningsooreenkomste</li>
                                                <li>Verkoop van besigheid</li>
                                                <li>Huurooreenkomste</li>
                                                <li>Kommersiële kontrakte</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Ontwikkelings</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4282">
                                        <div class="pf-content">
                                            <ul>
                                                <li>Dorpstigting</li>
                                                <li>Deeltitelregisters</li>
                                                <li>Kommersiële ontwikkelings</li>
                                                <li>Konsolidasie en onderverdeling van eiendom</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Oordrag van eiendomme</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4284">
                                        <div class="pf-content">
                                            <ul>
                                                <li>Voltitel en deeltitel</li>
                                                <li>Kommersiëel</li>
                                                <li>Bestorwe boedels</li>
                                                <li>Insolvente boedels</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Strukturering</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4287">
                                        <div class="pf-content">
                                            <ul>
                                                <li>Testamente</li>
                                                <li>Trusts</li>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Verbandregistrasies &amp; Kansellasies</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4289">
                                        <div class="pf-content">
                                            <ul>
                                                <li>Absa</li>
                                                <li>Eerste Nasionale Bank</li>
                                                <li>Nedbank</li>
                                                <li>Standard Bank</li>
                                                <li>Investec</li>
                                                <li>HIP (Housing Investment Partners)</li>
                                                <li>Privaat lenings</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br />
                            <div class="omsc-toggle">
                                <div class="omsc-toggle-title">Notariële Werk</div>
                                <div class="omsc-toggle-inner">
                                    <div class="content_block" id="custom_post_widget-4291">
                                        <div class="pf-content">
                                            <ul>
                                                <li>Huweliksvoorwaardekontrakte</li>
                                                <li>Notariële verbande</li>
                                                <li>Serwitute</li>
                                            </ul>
                                        </div>
                                    </div>
