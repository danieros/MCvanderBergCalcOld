<%@ Page Language="C#" MasterPageFile="~/AfrikaansSite.Master" AutoEventWireup="true" CodeBehind="Aanhangsels.aspx.cs" Inherits="MCvanderBergCalc.language.af.Aanhangsels" %>
...
<![endif]-->
	...
	<head profile="http://gmpg.org/xfn/11">
		...
		<title>Aanhangsels | M.C. van der Berg Incorporated</title>
...
<![endif]-->
		...
		<link rel="alternate" type="application/rss+xml" title="M.C. van der Berg Incorporated &raquo; Aanhangsels Comments Feed" href="http://gpdemo.co.za/mcconcept/language/af/aanhangsels/feed/" />
		<script type="text/javascript">
		...
		<link rel='canonical' href='http://gpdemo.co.za/mcconcept/language/af/aanhangsels/' />
		<link rel='shortlink' href='http://gpdemo.co.za/mcconcept/?p=938' />
...
<![endif]-->
	...
	<body class="page page-id-938 page-template-default custom-background _masterslider _ms_version_2.2.1 gecko et_includes_sidebar">
		...
		<div id="left-area">
			...
			<div id="entries">
				<div class="entry post clearfix">
					<h1 class="title">Aanhangsels</h1>


					<div class="pf-content">
						<p>
							<img src="http://www.mcvdbergattorneys.co.za/Data/Sites/3/media/agents_tools.jpg" alt="" />
						</p>
						<div class="omsc-accordion">
							<br />
							<div class="omsc-toggle">
								<div class="omsc-toggle-title">Aanhangsels</div>
								<div class="omsc-toggle-inner">
									</p>
																		<p>
																			<div class="content_block" id="custom_post_widget-4320">
																				<div class="pf-content">
																					<ul class="check-list">
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/Onderhewige-verkoop1.pdf" target="_blank">Onderhewige Verkoop</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/Verhuring2.pdf" target="_blank">Verhuring</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/AANHEGTINGS-EN-TOEBEHORE3.pdf" target="_blank">Aanhegtings &amp; Toebehore</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/Blanko-Addendum4.pdf" target="_blank">Blanko Addendum</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/07/Verslag-oor-die-toestand-van-die-onroerende-eiendom5.pdf" target="_blank">Verslag oor die toestand van die onroerende eiendom</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/07/Nul-Koers6.2.pdf" target="_blank">Nul Koers BTW transaksies</a></li>
																					</ul>
																				</div>
																			</div>
																		</p>
							...
							<br />
							<div class="omsc-toggle">
								<div class="omsc-toggle-title">Klousules</div>
								<div class="omsc-toggle-inner">
									</p>
																		<p>
																			<div class="content_block" id="custom_post_widget-4323">
																				<div class="pf-content">
																					<ul class="check-list">
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/elek-afr.pdf" target="_blank">Elektrisiteitsertifikaat</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/gas-afr.pdf" target="_blank">Gassertifikaat</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/elek-heining.pdf" target="_blank">Elektriese Omheiningssertifikaat</a></li>
																						<li><a href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/06/Geen-Agentekommissie-afr.pdf" target="_blank">Geen Agentekommissie</a></li>
																					</ul>
																				</div>
																			</div>
																		</p>
		...
		<!-- 130 queries in 0.862 seconds, using 24.13MB memory -->
