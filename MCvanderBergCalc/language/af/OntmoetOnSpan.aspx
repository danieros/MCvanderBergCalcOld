<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OntmoetOnSpan.aspx.cs" Inherits="MCvanderBergCalc.language.af.OntmoetOnSpan" %>
...
<title>Ontmoet ons dinamiese span | M.C. van der Berg Incorporated</title>
...
<style type="text/css" media="screen">.mymail-form{margin-bottom:20px;}.mymail-form .input, .mymail-form .mymail-form-info{width:100%;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;}.mymail-form label{line-height:1.6em;}.mymail-form li{list-style:none !important;margin-left:0;}.mymail-form label .required{color:#f33;}.mymail-form input.required{color:inherit;}.mymail-form .mymail-email{}.mymail-form .mymail-firstname{}.mymail-form .mymail-lastname{}.mymail-form .mymail-lists-wrapper ul{list-style:none;margin-left:0;}.mymail-form .mymail-lists-wrapper ul li{margin-left:0;}.mymail-form .mymail-list-description{color:inherit;display:block;margin-left:25px;font-size:0.8em;}.mymail-form .mymail-form-info{display:none;border-radius:2px;padding:5px;margin-bottom:4px;color:#fff;}.mymail-form .error input{border:1px solid #f33;}.mymail-form .mymail-form-info.error{background:#f33;}.mymail-form .mymail-form-info ul li{color:inherit;margin-left:0;}.mymail-form .mymail-form-info.success{background-color: #24890D;}.mymail-form .mymail-form-info p{margin-bottom:0;}.mymail-form .mymail-form-info ul{list-style-type:circle;margin-left:0;margin-bottom:0;}.mymail-form .submit-button{margin:6px 0 0;}.mymail-form .submit-button:active{margin:7px 1px 1px;}.mymail-form .mymail-loader{display: none;width:16px;height:16px;margin:4px;vertical-align: middle;background-image:url('http://gpdemo.co.za/mcconcept/wp-content/plugins/myMail/assets/img/loading.gif');background-repeat:no-repeat;background-position:center center;}.mymail-form .mymail-loader.loading{display: inline-block;}@media only screen and (-webkit-min-device-pixel-ratio: 2),only screen and (min--moz-device-pixel-ratio: 2),only screen and (-o-min-device-pixel-ratio: 2/1),only screen and (min-device-pixel-ratio: 2),only screen and ( min-resolution: 192dpi),only screen and ( min-resolution: 2dppx){ .mymail-form .mymail-loader{background-image:url('http://gpdemo.co.za/mcconcept/wp-content/plugins/myMail/assets/img/loading_2x.gif');background-size:100%;}}</style><link rel="alternate" type="application/rss+xml" title="M.C. van der Berg Incorporated &raquo; Feed" href="http://gpdemo.co.za/mcconcept/language/af/feed/" />
...
<link rel='canonical' href='http://gpdemo.co.za/mcconcept/language/af/ontmoet-ons-dinamiese-span/' />
<link rel='shortlink' href='http://gpdemo.co.za/mcconcept/?p=949' />
<meta name='generator' content='Event Espresso Version 3.1.37.3.P' /><script>var ms_grabbing_curosr = 'http://gpdemo.co.za/mcconcept/wp-content/plugins/master-slider/public/assets/css/common/grabbing.cur', ms_grab_curosr = 'http://gpdemo.co.za/mcconcept/wp-content/plugins/master-slider/public/assets/css/common/grab.cur';</script>
...
<link rel="alternate" href="http://gpdemo.co.za/mcconcept/language/en/meet-our-team/" hreflang="en" />
<link rel="alternate" href="http://gpdemo.co.za/mcconcept/language/af/ontmoet-ons-dinamiese-span/" hreflang="af" />
<!--[if IE 7]>
<link rel="stylesheet" href="http://gpdemo.co.za/mcconcept/wp-content/plugins/wp-review/assets/css/wp-review-ie7.css">
<![endif]-->
<!-- used in scripts --><meta name="et_featured_auto_speed" content="7000" /><meta name="et_disable_toptier" content="0" /><meta name="et_featured_slider_pause" content="0" /><meta name="et_featured_slider_auto" content="0" /><meta name="et_theme_folder" content="http://gpdemo.co.za/mcconcept/wp-content/themes/Aggregate" /><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" /><style type="text/css">#content-area { background-color: #b0b083; }#top-header { border-color: #b0b083; }#content-area { border-color: #b0b083; }#content-area { background-image: url(http://gpdemo.co.za/mcconcept/wp-content/themes/Aggregate/images/body-bg16.png); }</style><link id='droid_sans' href='http://fonts.googleapis.com/css?family=Droid+Sans' rel='stylesheet' type='text/css' /><style type='text/css'>body { font-family: 'Droid Sans', Arial, sans-serif !important;  }</style><style type='text/css'>body {  }</style><link rel="shortcut icon" href="http://gpdemo.co.za/mcconcept/wp-content/uploads/2015/04/favicon.ico" /><style type="text/css" id="custom-background-css">
...
<body class="page page-id-949 page-template-default custom-background _masterslider _ms_version_2.2.1 gecko et_includes_sidebar">
		...
		<div class="container clearfix">
			<a href="#" class="mobile_nav closed">Pages Navigation Menu<span></span></a>			<ul id="top-menu" class="nav"><li id="menu-item-2108" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2108"><a href="http://gpdemo.co.za/mcconcept/language/af/lede-inteken/">Lede Inteken</a></li>
...
<li id="menu-item-2091-en" class="lang-item lang-item-13 lang-item-en menu-item menu-item-type-custom menu-item-object-custom menu-item-2091-en"><a href="http://gpdemo.co.za/mcconcept/language/en/meet-our-team/" hreflang="en">English</a></li>
							...
							<div id="content-top-shadow">
								<div id="content-bottom-shadow">
									<div id="second-menu" class="clearfix">
										<a href="#" class="mobile_nav closed">Categories Navigation Menu<span></span></a>										<ul id="secondary-menu" class="nav"><li id="menu-item-177" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-177"><a href="http://gpdemo.co.za/mcconcept/language/af/tuis/">Tuis</a></li>
...
<ul class="sub-menu">
	<li id="menu-item-2070" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2070"><a href="http://gpdemo.co.za/mcconcept/language/af/oor-ons/">Hoekom ons</a></li>
	<li id="menu-item-2071" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-949 current_page_item menu-item-2071"><a href="http://gpdemo.co.za/mcconcept/language/af/ontmoet-ons-dinamiese-span/">Ontmoet ons dinamiese span</a></li>
</ul>
</li>
	...
	<div id="left-area">
		<div id="breadcrumbs">
					<a href="http://gpdemo.co.za/mcconcept/language/af/tuis/">Home</a> <span class="raquo">&raquo;</span>
									  ...
									  Ontmoet ons dinamiese span					</div> <!-- end #breadcrumbs -->		<div id="entries">
...
<p><div class='one_half'>
					<img src="http://www.mcvdberg.co.za/images/staff-94.jpg" alt="" width="400" height="588" /></p>
<h4>Tiaan (M.C.) van der Berg</h4>
<p>Direkteur<div class="omsc-accordion">
<div class="omsc-toggle"><div class="omsc-toggle-title">Tiaan se vol CV</div><div class="omsc-toggle-inner"></p>
<h4></h4>
<div class="four columns"></div>
<div class="four columns"><div class="content_block" id="custom_post_widget-4586"><div class="pf-content"><h4>Ondervinding</h4>
<h5>Direkteur by M. C. van der Berg Ingelyf</h5>
<p>Prokureurs, Aktevervaardigers en Notarisse
September 1999 &#8211; huidiglik</p>
<h5></h5>
<h5>Senior lektor by die Universiteit van Pretoria</h5>
<p>Aktes en Notariële Praktyk Siviele Prosesreg en Alternatiewe geskilbeslegtiging.
September 1999 &#8211; Julie 2005</p>
<h5></h5>
<h5>Professionele Assistent by DP Du Plessis Prokureurs</h5>
<p>Praktiseer as prokureur, aktevervaardiger en notaris wat spesialiseer in aktes en notariële werk.
Februarie 1998 &#8211; Augustus 1999</p>
<h5></h5>
<h5>Professionele Assistent by PRT Rudman Prokureurs</h5>
<p>Dien as kandidaatprokureur en daarna as &#8216;n prokureur, aktevervaardiger en notaris wat spesialiseer in aktes, siviele en kriminele reg in die landdroshof en hooggeregshof.
Julie 1996 &#8211; Februarie 1998</p>
<h5></h5>
...
<p></div></div>
					...
					<img src="http://www.mcvdberg.co.za/images/staff-95.jpg" alt="" width="400" height="588" /></p>
<h4>Sonja du Toit</h4>
<p>Direkteur<div class="omsc-accordion">
<div class="omsc-toggle"><div class="omsc-toggle-title">Sonja se vol CV</div><div class="omsc-toggle-inner"></p>
<h4></h4>
<div class="team-about"></div>
<div class="content_block" id="custom_post_widget-4588"><div class="pf-content"><h4>Ondervinding</h4>
<div class="team-about">
<div class="toggle-wrap">
<div class="toggle-container">
<h5>Direkteur by M. C. van der Berg Ingelyf</h5>
<p>Prokureurs, Aktevervaardigers en Notarisse
Maart 2010 &#8211; huidiglik</p>
<h5></h5>
<h5>Professionele Assistent by M.C. van der Berg Prokureurs</h5>
<p>Praktiseer as prokureur, aktevervaardiger en notaris en spesialiseer in aktes en notariële werk.
April 2004 &#8211; Februarie 2010</p>
<h5></h5>
<h5>Professionele Assistent by Van der Merwe du Toit Prokureurs</h5>
<p>Praktiseer as prokureur, aktevervaardiger en notaris en spesialiseer in aktes en handelsreg.
Januarie 2002 &#8211; Maart 2004</p>
<h5></h5>
<h5>Kandidaatprokureur by Van der Merwe du Toit Prokureurs</h5>
<p>Kandidaatprokureur in die litigasie, invorderings en aktevervaardigings departmente.
Januarie 2001 &#8211; Desember 2001</p>
<h5></h5>
<h4>Vaardighede &amp; Kundigheid</h4>
<div class="four columns">
<ul class="check-list">
...
<p><div class='one_fourth'>
					<img src="http://www.mcvdberg.co.za/images/team-37.jpg" alt="" width="175" height="257" /></p>
<h5>Nicole Rokebrand</h5>
<p>Professionele Assistent<div class="omsc-accordion">
<div class="omsc-toggle"><div class="omsc-toggle-title">Nicole se vol CV</div><div class="omsc-toggle-inner"></p>
<h4></h4>
<div class="four columns"></div>
<div class="four columns"><div class="content_block" id="custom_post_widget-4590"><div class="pf-content"><h4>Ondervinding</h4>
<h5>Professionele Assistent by M.C. van der Berg Berg Ingelyf</h5>
<p>Prokureurs, Aktevervaardigers en Notarisse
Oktober 2009 &#8211; huidiglik</p>
<h4></h4>
<h5>Kandidaatprokureur by M.C. van der Berg Prokureurs</h5>
<p>November 2007 &#8211; Maart 2009</p>
<h4></h4>
<h5>Dosent by Centurion Akademie</h5>
<p>Deeltydse dosent in Finansiële Bestuur/Boekhouding
Januarie 2004 &#8211; 2005</p>
<h4></h4>
<h4>Vaardighede &amp; Kundigheid</h4>
<div class="four columns">
<ul class="check-list">
...
<p>Golden Key International
Honour Society member</p>
<h5>Universiteit van Pretoria</h5>
...
<p>&nbsp;</p>
					...
					<img src="http://www.mcvdberg.co.za/images/team-38.jpg" alt="" width="175" height="258" /></p>
<h5>Rich Redinger</h5>
<p>Professionele Assistent<div class="omsc-accordion">
<div class="omsc-toggle"><div class="omsc-toggle-title">Rich se vol CV</div><div class="omsc-toggle-inner"></p>
<h4></h4>
<div class="four columns"></div>
<div class="four columns"><div class="content_block" id="custom_post_widget-4592"><div class="pf-content"><h4>Ondervinding</h4>
<h5>Professionele Assistent by M.C. van der Berg Ingelyf</h5>
<p>Prokureurs, Aktevervaardigers en Notarisse
Julie 2010 &#8211; huidiglik</p>
<h4></h4>
...
<p></div></div>
					...
					<p><img src="http://www.mcvdberg.co.za/images/team-36.jpg" alt="" width="175" height="257" /></p>
<h5>Annelé Odendaal</h5>
<p>Professionele Assistent<div class="omsc-accordion">
<div class="omsc-toggle"><div class="omsc-toggle-title">Annelé se vol CV</div><div class="omsc-toggle-inner"></p>
<h4></h4>
<div class="four columns"></div>
<div class="four columns"><div class="content_block" id="custom_post_widget-4594"><div class="pf-content"><h4>Ondervinding</h4>
<h5>Professionele Assistent by M.C. van der Berg Ingelyf</h5>
<p>Prokureurs, Aktevervaardigers en Notarisse
April 2010 &#8211; huidiglik</p>
<h4></h4>
<h5>Professionele Assistent by Strydom &amp; Bredenkamp Ing</h5>
<p>Praktiseer as prokureur, hoofsaaklik Hooggeregshof litigasie.
January 2010 &#8211; April 2010</p>
<h4></h4>
<h5>Professionele Assistent by Wessels &amp; Van Zyl Ing</h5>
<p>Praktiseer as prokureur, spesialiseer in aktevervaardiging en kommersiële reg.
August 2009 &#8211; December 2009</p>
<h4></h4>
<h4>Vaardighede &amp; Kundigheid</h4>
<div class="four columns">
<ul class="check-list">
...
<h5>Universiteit van Pretoria</h5>
<p>LLB, 2004 &#8211; 2008</p>
<h5>Hoërskool Dr Malan (Meyerton)</h5>
<p>Graad 12, 2003</p>
</div>
</div></div></div>
<p></div></div>
					...
					<p><img src="http://www.mcvdberg.co.za/images/MCimg-05.jpg" alt="" width="175" height="257" /></p>
<h5>Vernée Roets</h5>
<p>Professionele Assistent<div class="omsc-accordion">
<div class="omsc-toggle"><div class="omsc-toggle-title">Vernée se vol CV</div><div class="omsc-toggle-inner"></p>
<h4></h4>
<div class="four columns"></div>
<div class="four columns"><div class="content_block" id="custom_post_widget-4596"><div class="pf-content"><h4>Ondervinding</h4>
<h5>Professionele Assistent by M.C. van der Berg Ingelyf</h5>
<p>Prokureurs, Aktevervaardigers en Notarisse
Junie 2013 &#8211; huidiglik</p>
<h4></h4>
<h5>Professionele Assistent at Karen Meyer Lategan Prokureurs</h5>
<p>Prokureur en aktevervaardiger
Januarie 2013 – Mei 2013</p>
<h4></h4>
<h5>Kandidaatprokureur by Dyason Ing</h5>
<p>Januarie 2011 –Desember 2012</p>
<h4></h4>
<h4>Vaardighede &amp; Kundigheid</h4>
<div class="four columns">
<ul class="check-list">
...
<h4>Onderrig</h4>
<div class="four columns">
<h5>Universiteit van Stellenbosch</h5>
<p>LLB, 2007 &#8211; 2010</p>
<h5>Waterkloof Hoërskool</h5>
<p>Graad 12, 2006</p>
</div>
</div></div></div>
<p></div></div>
...
<div class="printfriendly pf-alignleft"><a href="http://www.printfriendly.com/print?headerImageUrl=http%3A%2F%2Fgpdemo.co.za%2Fmcconcept%2Fwp-content%2Fuploads%2F2015%2F04%2Fheader.png&amp;headerTagline=&amp;pfCustomCSS=&amp;imageDisplayStyle=block&amp;disableClickToDel=1&amp;disablePDF=0&amp;disablePrint=0&amp;disableEmail=0&amp;hideImages=0&amp;url=http%3A%2F%2Fgpdemo.co.za%2Fmcconcept%2Flanguage%2Faf%2Fontmoet-ons-dinamiese-span%2F&amp;source=wp" rel="nofollow"  class="noslimstat"><span class="printfriendly-text2">PDF / Email</span></a></div>	</div> <!-- end #left-area -->

	<div id="sidebar">
	<h4 class="main-title widget-title">Vinnige skakels</h4><div class="widget"><div class="menu-vinnige-skakels-container"><ul id="menu-vinnige-skakels" class="menu"><li id="menu-item-2105" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2105"><a href="http://gpdemo.co.za/mcconcept/language/en/mcost-calculator/">MCostCalculator</a></li>
</ul></div></div> <!-- end .widget --><h4 class="main-title widget-title">Gidse</h4><div class="widget"><div class="menu-gidse-container"><ul id="menu-gidse" class="menu"><li id="menu-item-2056" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2056"><a href="http://gpdemo.co.za/mcconcept/language/af/mc-verkopers-gids/">MCVerkopersGids</a></li>
...
</ul></div></div> <!-- end .widget --><h4 class="main-title widget-title">Videos</h4><div class="widget"><div class="menu-video-container"><ul id="menu-video" class="menu"><li id="menu-item-2060" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2060"><a href="http://gpdemo.co.za/mcconcept/language/af/mc-promosie-video/">MCPromosieVideo</a></li>
...
</ul></div></div> <!-- end .widget --><h4 class="main-title widget-title">MCLibrary</h4><div class="widget"><div class="menu-mclibrary-container"><ul id="menu-mclibrary" class="menu"><li id="menu-item-2066" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2066"><a href="http://gpdemo.co.za/mcconcept/language/af/mc-monthly-2/">MCMonthly</a></li>
...
</ul></div></div> <!-- end .widget --><h4 class="main-title widget-title">MCademy</h4><div class="widget"><div class="menu-mcademy-afrikaans-container"><ul id="menu-mcademy-afrikaans" class="menu"><li id="menu-item-2063" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2063"><a href="http://gpdemo.co.za/mcconcept/language/af/kursus-datums/">Kursus Datums</a></li>
</ul></div></div> <!-- end .widget --><h4 class="main-title widget-title">MCAgent&#8217;s Tools</h4><div class="widget"><div class="menu-mcagente-tools-container"><ul id="menu-mcagente-tools" class="menu"><li id="menu-item-2068" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2068"><a href="http://gpdemo.co.za/mcconcept/language/af/aanhangsels/">Aanhangsels</a></li>
...
</ul></div></div> <!-- end .widget --><h4 class="main-title widget-title">Ander</h4><div class="widget"><div class="menu-ander-container"><ul id="menu-ander" class="menu"><li id="menu-item-2094" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2094"><a href="http://gpdemo.co.za/mcconcept/language/af/gee-terugvoer/">Gee Terugvoer</a></li>
	...
	<div id="footer">
		<div id="footer-top-shadow" class="clearfix">
			<div class="container">
				...
				<a href="https://www.facebook.com/McVanDerBergInc" target="_blank"><img src="/mcconcept/wp-content/uploads/2015/07/facebook.png" height="32px" style="padding-bottom: 2px !important;" /></a> &nbsp; 
<a href="https://twitter.com/mcvanderberg" target="_blank"><img src="/mcconcept/wp-content/uploads/2015/07/Twitter.png" height="32px" style="padding-top: 15px !important;" /></a><p id="copyright">© Copyright 2015 M.C. Van Der Berg. All Rights Reserved.</p>
			</div> <!-- end .container -->
		</div> <!-- end #footer-top-shadow -->
		<div id="footer-bottom-shadow"></div>
		<div id="footer-bottom">
			<div class="container clearfix">
				<ul id="bottom-nav" class="bottom-nav"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-177"><a href="http://gpdemo.co.za/mcconcept/language/af/tuis/">Tuis</a></li>
...
<script src="http://gpdemo.co.za/mcconcept/wp-content/themes/Aggregate/js/custom.js" type="text/javascript"></script>	<script type="text/javascript">if(window.aiModifyParent) {aiModifyParent();}</script><script type="text/javascript">jQuery(function(){omShortcodes.init(["buttons","tooltips","toggle","tabs","responsivebox","counter"]);});</script><!-- Powered by WPtouch: 3.8.5 --><script type='text/javascript' src='http://gpdemo.co.za/mcconcept/wp-includes/js/comment-reply.min.js?ver=4.2.7'></script>
...
<!-- 146 queries in 0.943 seconds, using 24.16MB memory -->
